...
public class GUI extends javax.swing.JFrame {
    ...
    Cadena cadenaOBJ;
    String cadena;
    int posicion, orientacion, constanteAscii, valorRotacion;

    public GUI() {
        initComponents();
    }

    public void rotaCadena() {
        posicion = Integer.parseInt(jt2.getText());
        orientacion = Integer.parseInt(jt1.getText());
        this.cadena = tf1.getText();
        if (orientacion == 1) {
            String cadenaAux = "";
            System.out.println("Orientacion a la derecha");
            for (int i = posicion + 1; i >= 0; i--) {
                cadenaAux = cadenaAux + this.cadena.charAt(i);
    ...
    public void encriptaCadena() {
        this.cadena = tf1.getText();
        valorRotacion = Integer.parseInt(jt1.getText());
        posicion = Integer.parseInt(jt2.getText());
